---
name: release
description: Cut a new AnalogButtons release — suggests version bump based on change type, updates version files and CHANGELOG, commits, tags, pushes, creates a GitHub release, and publishes to PlatformIO
---

Cut a new AnalogButtons release. Follow these steps exactly:

## Step 1: Determine the version

Read `library.properties` to get the current version.
